...
void GameSceneLoad()
{
	...
	case (int)MapType::CityMap:
		...
		//!<街マップの画像読込ここまで
		LoadTexture("Res/Tex/Map/街/Object1.png", TEXTURE_CATEGORY_GAME, GameCategoryTextureList::GameObject2);
		LoadTexture("Res/Tex/Map/街/Object2.png", TEXTURE_CATEGORY_GAME, GameCategoryTextureList::GameObject);
		...
		LoadTexture("Res/Tex/Enemy/Gorilla/Boss3_SaruCall_Left.png", TEXTURE_CATEGORY_GAME, GameCategoryTextureList::GameEnemy_Attack4Left);
		LoadTexture("Res/Tex/Enemy/Gorilla/Boss3_SaruCall_Right.png", TEXTURE_CATEGORY_GAME, GameCategoryTextureList::GameEnemy_Attack4Right);
	...
	case (int)Player::PlayerTypeFlute:
		...
		LoadTexture("Res/Tex/FlutePlayer/Player_WalkAttack_Ft_Left.png", TEXTURE_CATEGORY_GAME, GameCategoryTextureList::GamePlayer_WalkAttack_LeftTex);
		LoadTexture("Res/Tex/FlutePlayer/Player_WalkAttack_Ft_Right.png", TEXTURE_CATEGORY_GAME, GameCategoryTextureList::GamePlayer_WalkAttack_RightTex);
		...
		LoadTexture("Res/Tex/FlutePlayer/Player_Jump_Ft_Right.png", TEXTURE_CATEGORY_GAME, GameCategoryTextureList::GamePlayer_Jump_RightTex);
		LoadTexture("Res/Tex/FlutePlayer/Player_JumpAttack_Ft_Left.png", TEXTURE_CATEGORY_GAME, GameCategoryTextureList::GamePlayer_JumpAttack_LeftTex);
		LoadTexture("Res/Tex/FlutePlayer/Player_JumpAttack_Ft_Right.png", TEXTURE_CATEGORY_GAME, GameCategoryTextureList::GamePlayer_JumpAttack_RightTex);
		LoadTexture("Res/Tex/FlutePlayer/Player_JumpDamage_Ft_Left.png", TEXTURE_CATEGORY_GAME, GameCategoryTextureList::GamePlayer_JumpDamage_LeftTex);
		LoadTexture("Res/Tex/FlutePlayer/Player_JumpDamage_Ft_Right.png", TEXTURE_CATEGORY_GAME, GameCategoryTextureList::GamePlayer_JumpDamage_RightTex);
		LoadTexture("Res/Tex/FlutePlayer/Player_Walk_Ft_Left.png", TEXTURE_CATEGORY_GAME, GameCategoryTextureList::GamePlayer_Walk_LeftTex);
		LoadTexture("Res/Tex/FlutePlayer/Player_Walk_Ft_Right.png", TEXTURE_CATEGORY_GAME, GameCategoryTextureList::GamePlayer_Walk_RightTex);
	...
	case (int)Player::PlayerTypeTuba:
		...
		LoadTexture("Res/Tex/TubaPlayer/Player_WalkAttack_Tb_Left.png", TEXTURE_CATEGORY_GAME, GameCategoryTextureList::GamePlayer_WalkAttack_LeftTex);
		LoadTexture("Res/Tex/TubaPlayer/Player_WalkAttack_Tb_Right.png", TEXTURE_CATEGORY_GAME, GameCategoryTextureList::GamePlayer_WalkAttack_RightTex);
