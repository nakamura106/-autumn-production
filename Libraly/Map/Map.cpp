...
{
	//マップ
	LoadTexture("Res/Tex/Map/森/Woods1.png", TEXTURE_CATEGORY_GAME, GameCategoryTextureList::GameFgTex);		//Stage1Bg1
	LoadTexture("Res/Tex/Map/森/Woods2.png", TEXTURE_CATEGORY_GAME, GameCategoryTextureList::GamefloorTex);	    //Stage1Bg2
	LoadTexture("Res/Tex/Map/森/Woods3.png", TEXTURE_CATEGORY_GAME, GameCategoryTextureList::Gamefloor2Tex);	//Stage1Bg3
	LoadTexture("Res/Tex/Map/森/Woods4.png",TEXTURE_CATEGORY_GAME,GameCategoryTextureList::GameBgTex);		    //Stage1Bg4
