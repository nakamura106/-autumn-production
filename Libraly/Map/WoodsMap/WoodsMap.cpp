...
void WoodsMap::Load()
{
	...
	LoadTexture("Res/Tex/Map/ŠC/Sea2.png", TEXTURE_CATEGORY_GAME, GameCategoryTextureList::GamefloorTex);	    //Stage1Bg2
	LoadTexture("Res/Tex/Map/ŠC/Sea3.png", TEXTURE_CATEGORY_GAME, GameCategoryTextureList::Gamefloor2Tex);	//Stage1Bg3
	LoadTexture("Res/Tex/Map/ŠC/Sea4.png", TEXTURE_CATEGORY_GAME, GameCategoryTextureList::GameBgTex);		    //Stage1Bg4
