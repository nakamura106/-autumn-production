...
public:
	...
	//éüÇÃÉQÅ[ÉÄÇ≈èâä˙âªÇµÇ»Ç¢Ç∆Ç¢ÇØÇ»Ç¢íl
	void ResetData();
	...
	void SetObjectHit(bool is_hit_object_) { m_is_hit_object = is_hit_object_; }
	...
	bool GetMapObjectHit() { return m_is_hit_object; }
